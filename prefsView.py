...
class PrefsDialog ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Preferences", pos = wx.DefaultPosition, size = wx.Size( 331,240 ), style = wx.DEFAULT_DIALOG_STYLE )
        ...
        self.chkDir = wx.CheckBox( self, wx.ID_ANY, u"Auto-create dirs based on genre", wx.DefaultPosition, wx.DefaultSize, 0 )
